...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function main() {
    ...
    // markerElement.innerHTML = '<a href="https://tokarevo-prom.ru" target="_blank"><img id="test" style="height:64px; width: 54px; min-width: 54px; min-height: 64px; transform: translateY(-64px);" src="https://optim.tildacdn.com/tild6265-3464-4432-b864-613863366136/-/format/webp/tokarevo.png.webp" alt=""></a>';
    ...
    // Add marker to map
    map.addChild(
      new YMapMarker({ coordinates: MARKER_COORDINATES }, markerContainer)
    );
    ...
    ADDITIONAL_MARKER_COORDINATES.forEach((coords, idx) => {
      ...
      extraMarkerElement.innerHTML = `<a href="#Sales"><img style="height:33.17px; width: 100px; min-width: 100px; min-height: 33.17px; transform: translateY(-33px);" src="${iconSrc}" alt=""></a>`;
      ...
      map.addChild(
        new YMapMarker({ coordinates: coords }, extraMarkerContainer)
      );
    });
  }
});
